# SafeChat Priority 1 Email Pack

Use these as starting points. Personalise the first paragraph and send from your own email account.
...
**Subject:** Request for review: SafeChat crisis resource routing

Hello [Name/Team],

[Personalised line]

I have built SafeChat, a privacy-preserving crisis safety protocol for AI chat systems. It detects textual distress signals locally in the browser, without sending user messages to a server, and routes people to verified professional crisis resources for their country.
...
**Subject:** SafeChat — local crisis routing layer for AI chat interfaces

Hello [Name/Team],

[Personalised line]

I have built SafeChat, a drop-in crisis safety layer for AI chat systems. It detects distress signals locally, collects no data, and routes users to verified professional crisis resources. It can run in the browser with one script tag or server-side through middleware.
